		...
		<div class="tab-pane active" id="movie_list">
			...
			<nav align="center">
				<ul class="pagination pagination-sm">
					...
					<spanaria-hidden="true">&laquo;</span></a></li>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="register_form">
						...
						<div class="form-group">
							<label for="movie_country">제작 국가</label> 
							<input type="text" name="movie_country" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="movie_summary">줄거리</label> 
							<input type="text" name="movie_summary" class="form-control">
						</div>
						<div class="form-group">
							<label for="movie_poster_img">포스터사진</label> 
							<input type="file" name="movie_poster_img" id="movie_poster_img"/>
						</div>
						<div class="form-group">
							<label for="movie_banner_img">배너사진</label> 
							<input type="file" name="movie_banner_img" id="movie_banner_img"/>
						</div>
					</form>
				</div>
